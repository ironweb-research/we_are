...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      <body
        className={cn(inter.className, "bg-slate-50	text-sky-700 dark:bg-black dark:text-slate-400")}
        >
        <Alert/>
        <ThemeSwitcher />
        <div className="border-neutral-200 mt-28 min-h-screen">{children}</div>
        <Footer />
      </body>
    </html>
  );
